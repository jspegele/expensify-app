...
// takes expenses array and filters object from state
// filters object is destructured into individual data items
...
const demoState = {
  expenses: [{
    ...
    note: 'This was the final payment for that addresss',
    amount: 54500,
    createdAt: 0
  }],
  filters: {
